...
public class MapActivity extends AppCompatActivity implements OnMapReadyCallback,
    ...
    public void onMapReady(GoogleMap googleMap) {
        Toast.makeText(this, "地圖已就緒", Toast.LENGTH_SHORT).show();
    ...
    private ImageView mGps, mInfo, mPlacePicker, mGetdirctions;
   ...
   // Object dataTransfer[] = new Object[2];
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mGetdirctions = (ImageView) findViewById(R.id.directions) ;
        ...
        mPlacePicker.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Log.e(TAG, "onClick: GoooglePlayServicesRepairableException: " + e.getMessage() );
                } catch (GooglePlayServicesNotAvailableException e) {
                    Log.e(TAG, "onClick: GoooglePlayServicesNotAvailableException: " + e.getMessage() );
                }
            }
        });
